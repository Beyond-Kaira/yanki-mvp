...
export default function SiteAuditSettingsDialog({
  ...
  // this form; the parent already memoises its own handler.
  ...
  return (
    <ModalDialog
      labelledBy="site-audit-settings-title"
      describedBy="site-audit-settings-domain"
      onDismiss={handleDismiss}
      dismissible={!submitting}
      initialFocusId="site-audit-page-limit"
