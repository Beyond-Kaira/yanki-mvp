...
➡️ **Next up: P7.3 (audit-event spine) then P7.2 (RBAC).** Both are
unblocked — P7.1's `OrgContext` is the seam they attach to. After them,
P7.6 (quotas + credit ledger) unblocks Phase 8's metering, and P8.4's
residual (liveness verifier + scheduled refresh) needs the worker wiring. **P5.11 (checker go-live) stays
