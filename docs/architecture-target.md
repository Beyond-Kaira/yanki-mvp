...
| `KeywordSource` | — (OSS preview: SearXNG expander + proxies; see [keyword-preview-oss.md](keyword-preview-oss.md)) | M6: licensed keyword metrics adapter; mock only for DRY_RUN/CI |
